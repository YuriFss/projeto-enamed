...
export function SimulationResult({ session, sessionQuestions }: SimulationResultProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <Link href="/simulado" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 mb-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <p className="text-xs text-gray-500 mt-2">Modo</p>
          </CardContent>
        </Card>
      </div>
